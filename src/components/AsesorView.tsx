      ...
      <div className="hidden lg:flex bg-slate-100 rounded-xl p-1 self-start">
        <button
          ...
          className={`px-4 py-2 text-xs font-bold rounded-lg transition-all cursor-pointer ${
            activeSubTab === 'checkin' ? 'bg-white text-rose-600 shadow-sm' : 'text-zinc-600 hover:text-[#282829]'
          }`}
        >
          🚙 Check-In Vehicular
        </button>
        <button
          ...
          className={`px-4 py-2 text-xs font-bold rounded-lg transition-all cursor-pointer ${
            activeSubTab === 'quotes' ? 'bg-white text-rose-600 shadow-sm' : 'text-zinc-600 hover:text-[#282829]'
          }`}
        >
          💰 Presupuestos / Costos
        </button>
        <button
          ...
          className={`px-4 py-2 text-xs font-bold rounded-lg transition-all cursor-pointer ${
            activeSubTab === 'monitor' ? 'bg-white text-rose-600 shadow-sm' : 'text-zinc-600 hover:text-[#282829]'
          }`}
        >
                    ...
                    <td className="py-3 px-4 text-center">
                      <div className="flex justify-center gap-1.5">
                        <button
                          ...
                          className="px-2 py-1 border border-slate-200 hover:border-slate-300 text-zinc-600 hover:text-[#282829] rounded text-[10px] font-bold flex items-center gap-1 bg-white cursor-pointer"
                        >
