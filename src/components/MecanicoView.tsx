...
export default function MecanicoView({ orders, onUpdateOrder, onSendToast }: MecanicoViewProps) {
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      ...
      {/* 1. Left Column: Big-button Assignment Selector */}
      ...
      {/* 2. Middle & Right: Selected Vehicle Details & Operations */}
      <div className="xl:col-span-2 flex flex-col gap-6">
        {selectedOrder ? (
          <div className="flex flex-col gap-6">
            ...
            {/* Additional Spare Parts discovered during teardown */}
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
          ...
          <div className="text-center p-12 bg-white border border-slate-200 rounded-2xl text-slate-400 text-xs shadow-sm">
            Ninguna rampa seleccionada. Seleccione un vehículo del tablero izquierdo para ver su asignación operativa.
          </div>
        )}
      </div>
